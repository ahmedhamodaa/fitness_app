                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 4.0),
                      Text('${workout.duration} min', style: TextStyle(fontSize: 14),),
                      SizedBox(width: 16.0),
                      Icon(Icons.fitness_center, size: 16.0),
                      SizedBox(width: 4.0),
                      Text(workout.difficulty, style: TextStyle(fontSize: 14),),
                      SizedBox(width: 16.0),
                      Icon(Icons.format_list_numbered, size: 16.0),
                      SizedBox(width: 4.0),
                      Text('${workout.exercises.length} exercises', style: TextStyle(fontSize: 14),),
                    ],
                  ),
                ],
              ),
